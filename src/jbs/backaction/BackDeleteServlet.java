...
@WebServlet(name = "BackDeleteServlet",urlPatterns = "/BackDeleteServlet")
public class BackDeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(b==true){
                response.sendRedirect("/BackListInfoServlet");
            }else{
