...
<form class="layui-form layui-form-pane" action="<%=basePath%>BackListServlet" method="post" enctype = "multipart/form-data">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="rdays" autocomplete="off" class="layui-input" value="${backListInfo.realmoney}" readonly>
        </div>
    </div>
    <div class="layui-form-item" align="center">
