...
<form class="layui-form" action="<%=basePath%>BackListAddServlet" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="bdate" id="date" lay-verify="date" autocomplete="off" class="layui-input"/>
        </div>
        <label class="layui-form-label">实际交付</label>
        <div class="layui-input-inline">
            <input type="text" name="realmoney" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item" align="center">
        <input class="layui-btn" lay-filter="demo2" type="submit" value="提交">
    </div>
    <br>
    <div>${msg}</div>
    <br>
