...
<form class="layui-form" action="<%=basePath%>CustomUpdateServlet" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="cname" lay-verify="name" value="${custom.cname}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">身份证号</label>
        <div class="layui-input-block">
            <input type="text" name="cidcard" lay-verify="identity" value="${custom.cidcard}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="phonenum" lay-verify="phone" autocomplete="off" class="layui-input" value="${custom.phonenum}">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">出生日期</label>
            <div class="layui-input-inline">
                <input type="text" name="birthday" id="date" lay-verify="date" value="<fmt:formatDate value="${custom.birthday}" pattern="yyyy/MM/dd"/>" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
